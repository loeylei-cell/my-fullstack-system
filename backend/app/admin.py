...
def get_admin_stats():
    ...
    try:
        ...
        # FIXED: Only count confirmed, processing, shipped, completed orders (exclude pending)
        ...
        return jsonify({
            ...
            "orderCount": order_count,  # Only confirmed+ orders
...
def get_dashboard_data():
    ...
    try:
        ...
        # 3. Top Customers by Order Value - FIXED: Only include completed orders
        ...
        # 6. Top Selling Products - FIXED: Only include completed orders
